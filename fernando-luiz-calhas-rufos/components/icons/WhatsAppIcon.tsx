...
/**
 * Glifo da marca WhatsApp (a lucide-react não inclui ícones de marca).
 * `aria-hidden` por padrão — o texto/`aria-label` do botão que o contém
 * é quem comunica o significado para leitores de tela.
 */
